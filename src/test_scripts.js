...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        var novel, novelId, retrievedNoveInfo, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, index_js_1.getOrInsertNovel)(novel)];
                case 1:
                    novelId = _a.sent();
                    return [4 /*yield*/, (0, index_js_1.insertChapter)(novelId, 'title1', "slug", 1.2, "this/isthe/path/tos3/file")];
                case 2:
                    _a.sent();
                    console.log("First Attempt: Inserted Author ID:", novelId);
                    return [4 /*yield*/, (0, index_js_1.getNovelBySlug)("peculiar-soul-1")];
                case 3:
                    retrievedNoveInfo = _a.sent();
                    console.log("Retreived Novel Info", retrievedNoveInfo);
                    return [3 /*break*/, 5];
                case 4:
                    error_1 = _a.sent();
                    console.error("Error during author upsert:", error_1);
                    return [3 /*break*/, 5];
                case 5: return [4 /*yield*/, (0, index_js_1.deleteAllData)().catch(console.error)];
                case 6:
                    _a.sent();
                    return [2 /*return*/];
            }
